              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <label
                      key={type.value}
                      className="flex items-center gap-3 border-2 border-gray-400 p-3 hover:bg-gray-50 cursor-pointer"
                    >
                      <input
                        type="radio"
                        name="reportType"
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center gap-2">
                    ...
                    <span className="text-sm">
                      Include AI analyses and suggestions
                    </span>
                  </label>
                  <label className="flex items-center gap-2">
                    <input type="checkbox" className="w-4 h-4" />
                    <span className="text-sm">
                      Include evidence links and source files
                    </span>
                  </label>
                  <label className="flex items-center gap-2">
                    <input type="checkbox" className="w-4 h-4" />
          ...
          <div className="border-2 border-gray-400 p-6">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={i}
                  className="border-2 border-gray-400 p-4 flex justify-between items-center"
                >
                  <div>
                    <div className="font-bold mb-1">{report.name}</div>
                    <div className="text-sm text-gray-600">
                      Generated: {report.date} • {report.format} •{' '}
        ...
        <div className="col-span-1">
          <div className="border-2 border-gray-400 p-6 mb-4 sticky top-8">
            ...
            <div className="space-y-4 text-sm">
              {[
                {
                  title: 'Individual',
                  desc: 'Personal report per student with scores, feedback and evidence overview.',
                },
                {
                  title: 'Group Overview',
                  desc: 'Comparison of all students with averages and distribution of scores.',
                },
                {
                  title: 'AI Analysis',
                  desc: 'Detailed overview of AI insights, overlap detections and warnings.',
                },
                {
                  title: 'Evidence Audit',
                  desc: 'Complete overview of all evidence documents with traceability to sources.',
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className={i > 0 ? 'border-t-2 border-gray-300 pt-4' : ''}
                >
          ...
          <div className="border-2 border-gray-400 p-4">
            ...
            <p className="text-xs text-gray-600">
              Reports may contain sensitive student data. Handle these according
              to GDPR guidelines and share only with authorized persons.
            </p>
          </div>
        </div>
      </div>
