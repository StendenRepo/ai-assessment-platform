            ...
            <div className="border-t-2 border-gray-300 pt-4">
              ...
              >
                ...
                <label
                  ...
                  className="inline-block border border-gray-400 px-3 py-1 text-xs cursor-pointer hover:bg-gray-100"
                >
                  [BROWSE]
                </label>
              </div>
              ...
              {uploadedFiles.length > 0 && (
                <div className="mt-3 space-y-1">
                  {uploadedFiles.map((file, index) => (
                    <div
                      key={index}
                      className="flex justify-between items-center border border-gray-400 p-2 text-xs"
                    >
                      ...
                      <button
                        ...
                        className="border border-gray-400 px-2 py-0.5 hover:bg-gray-100"
                      >
                        [X]
                      </button>
                    </div>
