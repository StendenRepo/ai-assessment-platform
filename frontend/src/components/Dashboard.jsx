...
export default function Dashboard() {
    ...
    return (<div>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        <div className="border-2 border-gray-400 p-6 cursor-pointer hover:border-black transition-all" onClick={() => router.push('/projects')}>
      ...
      <div className="space-y-4">
        {mockProjects.map((project) => (<div key={project.id} className="border-2 border-gray-400 p-6 hover:border-black cursor-pointer" onClick={() => router.push(`/projects/${project.id}`)}>
