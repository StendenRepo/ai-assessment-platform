...
class OverlapSignal(Base):
    ...
    student_a_id = Column(UUID(as_uuid=True), ForeignKey("students.id"), nullable=False)
    student_b_id = Column(UUID(as_uuid=True), ForeignKey("students.id"), nullable=False)
