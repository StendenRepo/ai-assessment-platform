...
| Method | Path                                                                                   | Story           |
| ------ | -------------------------------------------------------------------------------------- | --------------- |
| POST   | `/api/v1/modules/{moduleId}/projects/{projectId}/overlaps/detect`                      | G2-122          |
| POST   | `/api/v1/modules/{moduleId}/overlaps/detect-all`                                       | G2-122 + G2-123 |
| POST   | `/api/v1/modules/{moduleId}/overlaps/cross-group/detect`                               | G2-123          |
| GET    | `/api/v1/modules/{moduleId}/projects/{projectId}/overlaps?status=&scope=&sort=&order=` | G2-124, G2-126  |
